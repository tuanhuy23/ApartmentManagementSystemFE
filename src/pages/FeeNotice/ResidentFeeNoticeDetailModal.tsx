...
interface ResidentFeeNoticeDetailModalProps {
    open: boolean;
...
const ResidentFeeNoticeDetailModal: React.FC<ResidentFeeNoticeDetailModalProps> = ({
    open,
    feeNoticeId,
    onClose,
}) => {
    ...
    const fetchFeeNoticeDetail = async () => {
        ...
        try {
            setLoading(true);
            const response = await feeApi.getResidentFeeNoticeById(feeNoticeId);
            if (response.data) {
    ...
    const fetchFeeTypes = async () => {
        try {
            const response = await feeConfigurationApi.getResidentFeeConfigurations();
            if (response.data) {
...
export default ResidentFeeNoticeDetailModal;
